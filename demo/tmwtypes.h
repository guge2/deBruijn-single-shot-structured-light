...
#ifndef INT64_T
#if defined(__alpha) || defined(__sparcv9) || defined(__ia64) || defined(__ia64__) || defined(__x86_64__) || defined(__LP64__)
#define INT64_T long
#define FMT64   "l"
#elif defined(_MSC_VER) || (defined(__BORLANDC__) && __BORLANDC__ >= 0x530) || (defined(__WATCOMC__) && __WATCOMC__ >= 1100)
#define INT64_T __int64
#define FMT64   "I64"
#elif defined(__GNUC__) || defined(__hpux) || defined(__sun) || defined(TMW_ENABLE_INT64)
...
#if defined(_MSC_VER) || (defined(__BORLANDC__) && __BORLANDC__ >= 0x530) || (defined(__WATCOMC__) && __WATCOMC__ >= 1100)
#ifdef INT64_T
...
#define double_to_uint64(d)                                                                                  \
	(((d) > 0xffffffffffffffffu) ? (unsigned __int64)0xffffffffffffffffu :                                   \
	 ((d) < 0)                   ? (unsigned __int64)0 :                                                     \
	 ((d) > _I64_MAX)            ? (unsigned __int64)((d) - _I64_MAX) - 1 + (unsigned __int64)_I64_MAX + 1 : \
	                               (unsigned __int64)(d))
#else
...
#else
#define double_to_uint64(d) \
	(((d) > 0xffffffffffffffffLLU) ? (unsigned long long)0xffffffffffffffffLLU : ((d) < 0) ? (unsigned long long)0 : (unsigned long long)(d))
#endif
#endif
